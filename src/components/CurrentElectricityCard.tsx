...
import { average, formatEurCents, localTimeLabel, totalPrice, type Surcharge } from "@/lib/priceUtils";
...
export function CurrentElectricityCard({ current, todayPoints, surcharge }: { current: PricePoint | null; todayPoints: PricePoint[]; surcharge: Surcharge }) {
  ...
  return (
    <Card title="Huidige stroomprijs" subtitle={`Uur ${localTimeLabel(current.timestamp)}`}>
